...
def main():
    ...
    flower_class = [cla for cla in os.listdir("../Data/flower_data/flower_photos")
                    if os.path.isdir(os.path.join("../Data/flower_data/flower_photos", cla))]

    # 创建训练集train文件夹，并由类名在其目录下创建子目录
    train_root = "../Data/flower_data/train"
    mk_file(train_root)
    ...
    val_root = os.path.join("../Data/flower_data", "val")
    mk_file(val_root)
    for cla in flower_class:
        # 建立每个类别对应的文件夹
    ...
    for cla in flower_class:
        cla_path = os.path.join("../Data/flower_data/flower_photos", cla)
