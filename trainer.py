...
def main():
    ...
    train_dataset = datasets.ImageFolder(root='../Data/flower_data/train',
    ...
    # 加载测试数据集
    validate_dataset = datasets.ImageFolder(root='../Data/flower_data/val',
    ...
    best_acc = 0.0
    # 最佳模型保存地址
    save_path = "../TrainedModels/VGG16.model"
